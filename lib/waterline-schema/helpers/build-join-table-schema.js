...
module.exports = function buildJoinTableSchema(tableDef, schema) {
  ...
  var cOnePrimaryKeyDef = schema[c1.collection.toLowerCase()].schema[cOnePrimaryKey];
  var cTwoPrimaryKeyDef = schema[c2.collection.toLowerCase()].schema[cTwoPrimaryKey];
