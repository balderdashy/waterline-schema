...
module.exports = function buildJoinTableSchema(tableDef, schema) {
  ...
  var cOneColumnType = schema[c1.collection.toLowerCase()].schema[cOnePrimaryKey].autoMigrations.columnType;
  var cTwoColumnType = schema[c2.collection.toLowerCase()].schema[cTwoPrimaryKey].autoMigrations.columnType;
