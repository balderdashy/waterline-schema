...
module.exports = function buildJoinTableSchema(tableDef, schema) {
  ...
  table.attributes[c1.collection.toLowerCase() + '_' + c1.attribute.toLowerCase()] = {
    columnName: c1.collection.toLowerCase() + '_' + c1.attribute.toLowerCase(),
    ...
    via: c2.collection.toLowerCase() + '_' + c1.via,
    groupKey: c1.collection.toLowerCase()
  };

  // Foreign Key Collection Two
  table.attributes[c2.collection.toLowerCase() + '_' + c2.attribute.toLowerCase()] = {
    columnName: c2.collection.toLowerCase() + '_' + c2.attribute.toLowerCase(),
    ...
    via: c1.collection.toLowerCase() + '_' + c2.via,
    groupKey: c2.collection.toLowerCase()
  };

  table.joinedAttributes.push(c1.collection.toLowerCase() + '_' + c1.attribute.toLowerCase());
  table.joinedAttributes.push(c2.collection.toLowerCase() + '_' + c2.attribute.toLowerCase());
